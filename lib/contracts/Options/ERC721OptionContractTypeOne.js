...
async function exerciseERC721OptionNFT(
    ...
    console.log(`start exercise. 
        ...
        const settlementValueInDecimal = Number(settlementValue);

        await settlementTokenContract.connect(sellerAccount).approve(buyerAddress, settlementValueInDecimal); // Authorize payment to ERC721 contract.
