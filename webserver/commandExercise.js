...
const { mintERC721OptionNFT, erc721OptionNFTExists } = require("@lib/contracts/Options/ERC721OptionContractTypeOne"); // <- expose extra ERC721 calls here
const { persistOptionTerms, persistOptionIdExists } = require("@webserver/serverPersist"); // <- new delete method added here
